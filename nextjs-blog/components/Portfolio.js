            ...
            >
              <div className="portfolioContainer row">
                <div className="grid-item col-md-4 col-sm-6 col-xs-12 user-interface">
                  <figure>
                    <img src="/images/portfolio/g1.jpg" alt="img04" />
                ...
                <div className="grid-item col-md-4 col-sm-6 col-xs-12 ui mockup">
                  <figure>
                    <img src="/images/portfolio/g2.png" alt="img04" />
                    <figcaption className="fig-caption">
                      <i className="fa fa-search"></i>
                      <h5 className="title">Creative Design</h5>
                      <span className="sub-title">Photograpy</span>
                      <a
                        href="/images/portfolio/g2.png"
                        data-fancybox
                        data-src="#mh"
                      ></a>
                    </figcaption>
                ...
                <div className="grid-item col-md-4 col-sm-6 col-xs-12 user-interface">
                  <figure>
                    <img src="/images/portfolio/g3.png" alt="img04" />
                    <figcaption className="fig-caption">
                      <i className="fa fa-search"></i>
                      <h5 className="title">Creative Design</h5>
                      <span className="sub-title">Photograpy</span>
                      <a
                        href="/images/portfolio/g3.png"
                        data-fancybox
                        data-src="#mh"
                      ></a>
                    </figcaption>
                ...
                <div className="grid-item col-md-4 col-sm-6 col-xs-12 branding">
                  <figure>
                    <img src="/images/portfolio/g5.png" alt="img04" />
                    <figcaption className="fig-caption">
                      <i className="fa fa-search"></i>
                      <h5 className="title">Creative Design</h5>
                      <span className="sub-title">Photograpy</span>
                      <a
                        href="/images/portfolio/g5.png"
                        data-fancybox
                        data-src="#mh"
                      ></a>
                    </figcaption>
                ...
                <div className="grid-item col-md-4 col-sm-6 col-xs-12 user-interface">
                  <figure>
                    <img src="/images/portfolio/g4.png" alt="img04" />
                    <figcaption className="fig-caption">
                      <i className="fa fa-search"></i>
                      <h5 className="title">Creative Design</h5>
                      <span className="sub-title">Photograpy</span>
                      <a
                        href="/images/portfolio/g4.png"
                        data-fancybox
                        data-src="#mh"
                      ></a>
                    </figcaption>
                ...
                <div className="grid-item col-md-4 col-sm-6 col-xs-12 branding">
                  <figure>
                    <img src="/images/portfolio/g6.png" alt="img04" />
                    <figcaption className="fig-caption">
                      <i className="fa fa-search"></i>
                      <h5 className="title">Creative Design</h5>
                      <span className="sub-title">Photograpy</span>
                      <a
                        href="/images/portfolio/g6.png"
                        data-fancybox
                        data-src="#mh"
                      ></a>
                    </figcaption>
                ...
                <div className="grid-item col-md-4 col-sm-6 col-xs-12 branding">
                  <figure>
                    <img src="/images/portfolio/g8.png" alt="img04" />
                    <figcaption className="fig-caption">
                      <i className="fa fa-search"></i>
                      <h5 className="title">Creative Design</h5>
                      <span className="sub-title">Photograpy</span>
                      <a
                        href="/images/portfolio/g8.png"
                        data-fancybox
                        data-src="#mh"
                      ></a>
                    </figcaption>
                ...
                <div className="grid-item col-md-4 col-sm-6 col-xs-12 ui">
                  <figure>
                    <img src="/images/portfolio/g9.png" alt="img04" />
                    <figcaption className="fig-caption">
                      <i className="fa fa-search"></i>
                      <h5 className="title">Creative Design</h5>
                      <span className="sub-title">Photograpy</span>
                      <a
                        href="/images/portfolio/g9.png"
                        data-fancybox
                        data-src="#mh"
                      ></a>
                    </figcaption>
                ...
                <div className="grid-item col-md-4 col-sm-6 col-xs-12 branding">
                  <figure>
                    <img src="/images/portfolio/g7.jpg" alt="img04" />
                    <figcaption className="fig-caption">
                      <i className="fa fa-search"></i>
                      <h5 className="title">Creative Design</h5>
                      <span className="sub-title">Photograpy</span>
                      <a
                        href="/images/portfolio/g7.jpg"
          ...
          <div className="row mh-portfolio-modal-inner">
            ...
            <div className="col-sm-7">
              <div className="mh-portfolio-modal-img">
                <img src="/images/pr-0.jif" alt="" className="img-fluid" />
                <p>
                  All variations are organized separately so you can use /
                  customize the template very easily.
                </p>
                <img src="/images/pr-1.jif" alt="" className="img-fluid" />
                <p>
                  All variations are organized separately so you can use /
                  customize the template very easily.
                </p>
