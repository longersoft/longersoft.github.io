                ...
                <div className="col-sm-12 mh-featured-item">
                  <div className="row">
                    <div className="col-sm-7">
                      <div
                        className="mh-featured-project-img shadow-2 wow fadeInUp"
                    ...
                    <div className="col-sm-5">
                      <div className="mh-featured-project-content">
                        <h4
                          className="project-category wow fadeInUp"
                          data-wow-duration="0.8s"
                          data-wow-delay="0.4s"
                        >
                          Web Design
                        ...
                        <p
                          ...
                          data-wow-delay="0.7s"
                        >
                          Stamp is a clean and elegant Multipurpose Landing Page
                        ...
                        <div
                          className="mh-testimonial mh-project-testimonial wow fadeInUp"
                          data-wow-duration="0.8s"
                          data-wow-delay="0.9s"
                        >
                          <blockquote>
                            <q>
                              Excellent Template - suits my needs perfectly
                              whilst allowing me to learn some new technology
                              first hand.
                            </q>
                          ...
                          <blockquote>
                            <q>
                              Creative Template - suits my needs perfectly
                              whilst allowing me to learn some new technology
                              first hand.
                            </q>
                            <cite>- Shane Kavanagh</cite>
                          ...
                          <blockquote>
                            <q>
                              Organize Code - suits my needs perfectly whilst
                              allowing me to learn some new technology first
                              hand.
                            </q>
                            <cite>- Shane Kavanagh</cite>
                          </blockquote>
